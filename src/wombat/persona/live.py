...
# wombat.config.APP_EDITABLE_FIELDS) — the ONLY keys this class ever reads or writes.
...
class LivePersona:
    ...
    def set(self, matrix: PersonaMatrix) -> None:
    ...
    def _persist(self, matrix: PersonaMatrix) -> None:
        ...
        five persona keys (never ``.env``, never a secret field — this class never touches
        either)."""
