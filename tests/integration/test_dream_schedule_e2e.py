...
class _PassthroughDeriveStage:
    """TK-299 mechanical reshape: ``wombat.dream``'s new sixth stage — always transitions straight
    onward; it carries none of ``DreamDeriveStage``'s own read/derive behavior (TK-299 owns that,
    out of scope for the TK-52 timer/fence suite this file tests)."""
...
class _PassthroughObserveStage:
    """TK-314 mechanical reshape (flagged per the ticket's own sanction): ``wombat.dream``'s new
    ``dream_observe`` stage — always transitions straight onward; it carries none of
    ``DreamObserveStage``'s own ledger-distillation behavior (TK-314 owns that, out of scope for
...
class _PassthroughBiometricsStage:
    """TK-346 mechanical reshape (flagged per the ticket's own sanction): ``wombat.dream``'s new
    ``dream_biometrics`` stage — always transitions straight onward; it carries none of
    ``DreamBiometricsStage``'s own biometric-distillation behavior (TK-346 owns that, out of scope
    for the TK-52 timer/fence suite this file tests)."""
